...
#Daily task
#covMas <- rbind(covMas %>% select(-X),data.frame(date=as.character(make_date(2020,4,22)),presumptive=NA, confirmed=NA, total=42944, death=2182, quarantined =22952, Quarfinished = 13480, quarantNow=9472))
